    ...
    <div className="lg:mb-0 mb-10">
      <div className="group w-full h-full">
        <div className="relative h-full min-h-[500px] lg:min-h-[600px]">
          ...
          <div className="absolute inset-0 overflow-hidden lg:rounded-l-2xl rounded-2xl">
            <img 
              src={home} 
              alt="Background" 
          ...
          <div className="relative h-full flex flex-col justify-between z-10">
            <h1 className="text-white text-4xl font-bold leading-10 pt-11 pl-11 font-manrope">
              Contact us
            </h1>
...
// Keep all other components exactly the same as before:
...
const ContactInfoItem = ({ icon, text }) => {
  return (
    <a href="#" className="flex items-center mb-6 last:mb-0">
      {icon}
  ...
  return (
    <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
      ...
      <div className="mb-10">
        ...
        <div className="flex">
          <RadioOption id="radio-group-1" label="Email" name="radio-group" />
          <RadioOption id="radio-group-2" label="Phone" name="radio-group" />
        </div>
      </div>
...
const RadioOption = ({ id, label, name }) => {
  return (
    <div className="flex items-center mr-11">
      ...
      />
      <label htmlFor={id} className="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
