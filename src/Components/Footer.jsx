        ...
        <div className="mx-auto max-w-8xl px-4 sm:px-6 lg:px-20">
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                  <div className='items-center'><h1 className='font-bold text-3xl'>Furniro</h1></div>
                    <p className="py-4 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted in more than 100 countries & 5 million customers. Have any query ?</p>
                ...
                <div className="lg:mx-auto text-left ">
                    ...
                    <ul className="text-sm  transition-all duration-500">
                        ...
                        <li className="mb-6"><Link to="/shop"  className=" text-gray-600 hover:text-gray-900">Shop</Link></li>
            ...
            <div className="py-7 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span className="text-sm text-gray-500 ">©<a href="https://pagedone.io/">Furniro</a> 2025, All rights reserved.</span>
